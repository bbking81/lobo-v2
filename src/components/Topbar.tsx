  ...
  return (
    ...
    >
      ...
      <Link href="/" className="flex items-center gap-2.5 lg:gap-3.5 cursor-pointer shrink-0 min-w-0" title="Ir al inicio">
        ...
        <img
          src="https://loboentrerriano.com/static/logo.png?v=gec7"
        ...
        <div className="min-w-0" style={{ lineHeight: 1.1 }}>
          ...
          <div className="whitespace-nowrap uppercase text-[0.5rem] lg:text-[0.62rem]" style={{ fontWeight: 700, color: '#0193de', letterSpacing: '0.22em', fontFamily: 'var(--font-archivo), system-ui, sans-serif', marginTop: 4 }}>
            · Estadísticas ·
          </div>
        </div>
      </Link>
