...
function SectionLabel({ label, titular }: { label: string; titular?: boolean }) {
  return (
    <div className="flex items-center gap-1.5 uppercase" style={{ padding: '8px 16px', fontSize: '0.75rem', fontWeight: 800, letterSpacing: '0.1em', color: '#92400e', background: '#fefce8', borderBottom: '1px solid #fde68a' }}>
      {titular
        ...
        : <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#92400e" strokeWidth="2"><circle cx="9" cy="7" r="4" /><path d="M3 21v-2a4 4 0 0 1 4-4h4" /><circle cx="19" cy="11" r="3" /><path d="M17 21v-1a3 3 0 0 1 3-3" /></svg>}
      {label}
    </div>
  )
}
