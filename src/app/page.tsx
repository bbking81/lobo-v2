      ...
      <div className="px-5 py-5 max-w-[1100px] mx-auto space-y-5">
        ...
        <div className="grid gap-5 grid-cols-1 sm:grid-cols-2">
          ...
          <Podio titulo="Máximos Goleadores" jugadores={maxGoleadores} campo="goles" sufijo="⚽" tema="ambar"
            ...
            icon={<svg width="19" height="19" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><circle cx="12" cy="12" r="9"/><path d="M12 7l4.755 3.455l-1.82 5.59h-5.87l-1.82 -5.59z"/><path d="M12 7v-3.5"/><path d="M16.755 10.455l3.331 -1.083"/><path d="M14.936 16.045l2.063 2.835"/><path d="M9.064 16.045l-2.063 2.835"/><path d="M7.245 10.455l-3.331 -1.083"/></svg>} />
        </div>
