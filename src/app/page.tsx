...
/* Header de card — gradiente #0f1e35 → #1e4a8a */
...
/* ── Banner próximo partido — "marcador clásico" (opción 1): tarjeta clara,
      escudos a los costados con nombre, hora grande al centro, fecha + estadio
